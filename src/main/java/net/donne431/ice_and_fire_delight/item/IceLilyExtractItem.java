...
import net.donne431.ice_and_fire_delight.procedures.IceLilyExtractWhenDrinkedProcedure;
import net.donne431.ice_and_fire_delight.init.IceAndFireDelightModItems;

import java.util.List;

public class IceLilyExtractItem extends Item {
	public IceLilyExtractItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		IceLilyExtractWhenDrinkedProcedure.execute(entity);
