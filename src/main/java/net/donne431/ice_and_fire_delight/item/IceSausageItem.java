...
import net.donne431.ice_and_fire_delight.procedures.IceSausageWhenEatedProcedure;

import java.util.List;

public class IceSausageItem extends Item {
	public IceSausageItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		IceSausageWhenEatedProcedure.execute(entity);
		return retval;
	}
}
