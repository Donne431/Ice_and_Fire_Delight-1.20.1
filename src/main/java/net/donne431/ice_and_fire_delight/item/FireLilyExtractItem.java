...
import net.donne431.ice_and_fire_delight.procedures.FireLilyExtractWhenDrinkedProcedure;
import net.donne431.ice_and_fire_delight.init.IceAndFireDelightModItems;

import java.util.List;

public class FireLilyExtractItem extends Item {
	public FireLilyExtractItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		FireLilyExtractWhenDrinkedProcedure.execute(entity);
