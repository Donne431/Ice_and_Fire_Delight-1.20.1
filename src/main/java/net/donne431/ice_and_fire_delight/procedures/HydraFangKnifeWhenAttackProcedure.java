...
public class HydraFangKnifeWhenAttackProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if ((sourceentity instanceof LivingEntity _entity) ? _entity.isHolding(IceAndFireDelightModItems.HYDRA_FANG_KNIFE.get()) : false) {
