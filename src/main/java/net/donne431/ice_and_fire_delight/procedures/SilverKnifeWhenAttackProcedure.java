...
public class SilverKnifeWhenAttackProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if ((sourceentity instanceof LivingEntity _entity) ? _entity.isHolding(IceAndFireDelightModItems.SILVER_KNIFE.get()) : false) {
