...
import net.donne431.ice_and_fire_delight.potion.CenterOfWeaknessMobEffect;
...
public class IceAndFireDelightModMobEffects {
	...
	public static final RegistryObject<MobEffect> CENTER_OF_WEAKNESS = REGISTRY.register("center_of_weakness", () -> new CenterOfWeaknessMobEffect());
}
